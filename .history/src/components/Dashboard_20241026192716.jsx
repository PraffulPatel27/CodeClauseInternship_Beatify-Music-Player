      ...
      <aside className="w-64 bg-gray-900 text-white p-10 border border-red-500">
        ...
        <nav>
          ...
          {/*** Menu ***/}
            <li className="mb-2">
              <div className="flex items-center gap-x-2">
                <img src={assets.homeIcon} alt="Home" className="w-6 h-6"/>

                <button 
                  className={`w-full text-left text-lg ${selectedFeature === 'home' ? 'text-white' : ''}`}
            ...
            <li className="mb-2">
              <div className="flex items-center gap-x-2">
                <img src={assets.albums} alt="Home" className="w-6 h-6"/>
          ...
          {/*** Library ***/}
            <li className="mb-2">
              <div className="flex items-center gap-x-2">
                ...
                <button 
                className={`w-full text-left text-lg ${selectedFeature === 'recent' ? 'text-white' : ''}`}
            ...
            <li className="mb-2">
              <button 
                className={`w-full text-left ${selectedFeature === 'recent' ? 'text-wh' : ''}`}
                onClick={() => setSelectedFeature('recent')}
              >
                Most played
              </button>
          ...
          {/*** Playlist and favourite ***/}
            ...
            <li className="mb-2">
              <button 
                className={`w-full text-left ${selectedFeature === 'liked' ? 'text-wh' : ''}`}
            ...
            <li className="mb-2">
              <button 
                className={`w-full text-left ${selectedFeature === 'playlists' ? 'text-wh' : ''}`}
