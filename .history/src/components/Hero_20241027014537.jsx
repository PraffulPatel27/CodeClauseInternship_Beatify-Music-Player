                ...
                <div className='mx-auto max-w-screen-xl px-4 py-32 grid grid-cols-1 lg:grid-cols-2 lg:h-screen lg:items-center'>
                    <div className="mx-auto max-w-[40rem] text-center">
                        ...
                        <div className="mt-8 flex flex-wrap justify-center gap-4">
                            ...
                            <a className="block rounded border border-[#65D36E] bg-[#65D36E] sm:px-12 px-10 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto hover:shadow-2xl hover:shadow-[#65D36E]" href="userDashboard">
