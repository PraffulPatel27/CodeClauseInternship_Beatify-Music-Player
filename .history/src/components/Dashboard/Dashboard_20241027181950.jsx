    ...
    <div className="flex h-screen">
      ...
      <div className='w-full h-20 p-4 bg-[#181818]'>
        ...
        <header className="flex items-center justify-between">
          ...
          <div className="w-522 flex justify-end gap-x-6">
            <button className="px-4 py-2 text-center text- text-white rounded-3xl bg-gradient-to-r from-green-400 to-blue-500">
              Premuim
            </button>
