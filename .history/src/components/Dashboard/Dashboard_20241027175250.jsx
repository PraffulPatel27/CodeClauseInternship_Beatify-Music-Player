...
const Dashboard = ({
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Main Content */}
      <main className="ml-64 flex-1 bg-gray-200 overflow-y-auto">
      {/* Header Section */}
      <div className='w-full h-20 p-4 bg-gray-400'>
        <header>
          {/** Search Bar **/}
          <div className="mb-4">
           <input
            ...
            className="w-full p-2 rounded-lg bg-white text-gray-300 border-2 border-[#ACACAC]"
           />
          </div>

          {/** User Profile **/}
          <div>
            <button className="p-2 rounded bg-gradient-to-r from-green-400 to-blue-500">
              Premuim
            </button>

            <div className="border-lg border-gray-300">
              <img src={assets.userProfile} alt="User Profile" className="w-10 h-10 rounded-full" />
            </div>
          </div>
        </header>
      </div>
