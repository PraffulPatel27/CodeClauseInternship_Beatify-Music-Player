    ...
    <div className="flex h-screen">
      ...
      <div className='w-full h-20 p-4 bg-gray-400'>
        <header className="grid grid-cols-2 items-center gap-x-10">
          ...
          {/** User Profile **/}
          <div className='w-full grid grid-cols-2 items-center justify-end gap-x-4'>
            <button className="p-2 text-white rounded-3xl bg-gradient-to-r from-green-400 to-blue-500">
              Premuim
            </button>
