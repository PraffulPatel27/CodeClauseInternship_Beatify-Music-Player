  ...
  return (
    <div className="flex h-screen">
      ...
      <div className='w-full h-20 p-4 bg-gray-400'>
        ...
        <header className="grid grid-cols-2 items-center gap-">
          {/** Search Bar **/}
          <div className="mb-4">
           <input
            type="text"
          ...
          <div className="flex justify-end gap-x-6">
            <button className="px-4 py-1 text-center text-white rounded-3xl bg-gradient-to-r from-green-400 to-blue-500">
              Premuim
            </button>
