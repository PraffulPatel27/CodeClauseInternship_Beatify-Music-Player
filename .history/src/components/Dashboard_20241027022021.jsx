        ...
        <nav>
          <ul className="space-y-4">
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'upload' ? 'bg-gray-800 text-gree-500' : ''
                }`}
                onClick={() => setSelectedFeature('upload')}
              >
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'recent' ? 'bg-gray-800 text-gree-500' : ''
                }`}
                onClick={() => setSelectedFeature('recent')}
              >
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'mostPlayed' ? 'bg-gray-800 text-gree-500' : ''
                }`}
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'favorites' ? 'bg-gray-800 text-gree-500' : ''
                }`}
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'playlists' ? 'bg-gray-800 text-gree-500' : ''
                }`}
                onClick={() => setSelectedFeature('playlists')}
              >
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'addPlaylist' ? 'bg-gray-800 text-gree-500' : ''
                }`}
            ...
            <li className="mb-3">
              <button
                className={`w-full text-left flex items-center p-2 rounded hover:bg-gray-800 ${
                  selectedFeature === 'settings' ? 'bg-gray-800 text-gree-500' : ''
                }`}
