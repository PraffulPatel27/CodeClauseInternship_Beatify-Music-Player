      ...
      <header className='bg-transparent transition-colors duration-300 sticky top-0 z-50 border-b border-gray-800'>
        <div className="mx-auto w-[100%] md:max-w-screen-xl lg:max-w-screen-xl flex h-18 py-2 items-center gap-4 lg:gap-16 px-2 sm:px-4 md:px-6 lg:px-6">
          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-4 lg:gap-4">
              <a className="w-21 sm:w-28 block rounded-md bg-transparent px-4 sm:px-5 py-2.5 text-sm text-center font-medium text-[#65D36E] border border-[#65D36E] transition hover:bg-[#65D36E] hover:text-white" 
                href="home">
                Login 
              </a>

              <a className="w-21 sm:w-28 text-center block rounded-md bg-[#65D36E] px-4 sm:px-5 py-2.5 text-sm font-medium text-white transition hover:bg-transparent hover:text-[#65D36E] hover:border hover:border-[#65D36E]" 
              href="files">
                Sign Up 
              </a>
